...
void main() {
  runApp(MaterialApp(
    ...
    routes: {
      ...
      '/second': (context) => OTPVerficationState(),
...
class DrMohanApp extends StatelessWidget {
  ...
  static BuildContext DrMohanAppbuildContext = BuildContext as BuildContext;
  ...
  static loadOTPVerficationScreen() {
    /*Navigator.push(
      DrMohanAppbuildContext,
      MaterialPageRoute(builder: (buildContext) => OTPVerficationState()),
    );*/
  }
  ...
  @override
  Widget build(BuildContext context) {
    DrMohanAppbuildContext = context;
          ...
          if (snapshot.hasData) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => OTPVerficationState()),
                );
              },
...
class OTPVerficationState extends StatefulWidget {
  createState() {
...
class OTPVerification extends State<OTPVerficationState> {
  ...
  static String phone = "";
  static String OTPsenttophonemsg = "";
  ...
  Widget build(BuildContext context) {
    ...
    callToSetAppBarTitle();
    print(OTPVerification.getotpstr + " OTPVerification.getotpstr");
    if (OTPVerification.getotpstr != "") {
    ...
    return WillPopScope(
        ...
        onWillPop: () {
          if (ProfileScreen.profilescreenloaded == "false") {
            print("ProfileScreen.profilescreenloaded --> ");
            Navigator.pop(
                buildContext,
                MaterialPageRoute(
            ...
            Navigator.of(context).pushReplacement(MaterialPageRoute(
              builder: (context) => OTPVerficationState(),
            ));
          }
...
class ProfileScreen extends StatelessWidget {
  ...
  static String profilescreenloaded = "false";
...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: BottomAppBarWidget(),
    );
  }
