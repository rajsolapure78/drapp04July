...
class HealthRecordScreen extends StatelessWidget {
  ...
  static List<String> healthrecordTitles = [];
  static List<String> healthrecordImgUrl = [];
  static List<String> healthrecordScreens = [];
  static List<VisitSummayItem> visitSummayItems = [];

  callToSetAppBarTitle() => createState().setAppBarTitle("Health Record");
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarWidget(),
      body: FutureBuilder(
        future: httpService.getHealthRecordVisitSummaryItems(),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: healthrecordTitles.length,
                                  ...
                                  color: Colors.white),*/
                                    child: Card(
                                        child: InkWell(
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                Container(height: MediaQuery.of(context).size.height * 0.1, width: MediaQuery.of(context).size.width * 0.8, margin: EdgeInsets.only(right: 0), child: CircleAvatar(backgroundColor: Colors.white, child: Image.network(DrMohanApp.appinfoitems![0].srntxt2 + healthrecordImgUrl[index]))),
                                                Container(
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: visitSummayItems.length,
                          itemBuilder: (BuildContext context, int index) {
                            return MouseRegion(
                                onHover: (event) {
                                  // appContainer.style.cursor = 'pointer';
                                ...
                                child: Container(
                                    ...
                                    child: Card(
                                        color: Color.fromRGBO(137, 176, 183, 1.0),
                                        child: InkWell(
                                            /*onTap: () {
                                        print("tapped");
                                        String srn = healthrecordScreens[index];
                                          ...
                                          children: <Widget>[
                                            Container(
                                                ...
                                                child: Html(
                                                  data: visitSummayItems![index].Doctor + "<br>" + visitSummayItems![index].Dpt + "<br>" + visitSummayItems![index].VisitDate + "<br>",
