...
class VitalsTrackerTile extends StatefulWidget {
  ...
  const VitalsTrackerTile({Key? key, required this.bloodPressureItem, required this.bloodPressureVitalId, required this.bloodPressureVitals, required this.weightItem, required this.weightVitalId, required this.bloodPressureRef, required this.weightRef}) : super(key: key);
            ...
            InkWell(
              ...
              child: ListTile(
                ...
                leading: SizedBox(
                  ...
                  child: Image.network(DrMohanApp.appinfoitems[0].srntxt2 + 'images/weight.png'),
                ),
                title: Text(
                  "Weight",
                  style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: constraints.maxWidth * 0.061),
                ),
                subtitle: Row(
                  ...
                  children: [
                    Text(
                      widget.weightRef,
                      style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: constraints.maxWidth * 0.078),
                    ),
                    // Text(
                    //   "kg",
                    //   style: TextStyle(
            ...
            InkWell(
              ...
              child: ListTile(
                ...
                leading: SizedBox(
                  height: constraints.maxHeight * 0.154,
                  width: constraints.maxWidth * 0.174,
                  child: Image.network(DrMohanApp.appinfoitems[0].srntxt2 + 'images/bloodpressure.png'),
                ),
                title: Text(
                  "Blood Pressure",
                  style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: constraints.maxWidth * 0.061),
                ...
                subtitle: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: constraints.maxWidth * 0.043),
                    ),
                  ],
                ),
              ),
